...
WHISPER_LANGUAGE = "ky"  # Кыргызский язык (ky = Kyrgyz ISO 639-1)
# Подсказка для Whisper — частые слова из контекста приложения помогают распознаванию
WHISPER_PROMPT = (
    "Такси, жөнөтүш, алып кет, кафе, аптека, дарыкана, дарак, портер, жүк, ун, "
    "Шамалды-Сай, базар, түндүк, түштүк, мечит, мектеп, больница, "
    "заказ, баасы, сом, жок, ооба, отмена, ыракмат, рахмат, "
    "светофор, светофордон, светофорго, "
    "северная, севернаяга, Пушкина, Ленина, "
    "Адыл кафеге, Адылга, Жумабекке, "
    "трассага, мертвыйга, "
    "номер 2ге, миллионго, Глобуска, Глобустан, "
    "12чиге, ынтымакка, "
    "номер 8ге, Ленинага, Ленинадан, "
    "спортивная, спортивнаяга, "
    "Ак Кемеге, центральный мечетке, центральный мечеттен, "
    "двойняшкиге, Грин Хауска, ЖДга"
)
