...
WHISPER_PROMPT = (
    ...
    "Кеңешбек-Ата, Жээнмырза, Атакулов, Пионерская, Токтосуна-Абайдуллаева, "
    "Фрунзе, Панфилова, Исанова, Кураева, Сергеева, Чынгыза Айтматова, "
    "Ыскака Раззакова, Тыныбекова, Орозбекова, Зулпукарова, Тарыкчиева, "
