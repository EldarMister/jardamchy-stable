...
WELCOME_MESSAGE = """👋 *"Жардамчы GO"* — Шамалдуу-Сайдагы бардык кызматтар бир жерде!

Тизмени тандап, ишиңизди жеңилдетиңиз:
_(Текстти жазбай, жөн гана керектүү кызматтын санын жибериңиз)_

🍔 *1. Даамдуу тамак* (Кафелер)
🛒 *2. Дүкөндөн жеткирүү* (Азык-түлүк)
🚖 *3. Тез Такси* (Шаар ичинде)
🚚 *4. Портер* (Чоң жүк ташуу)
🛵 *5. Желмаян* (Майда жүк, тезирээк)
👩‍⚕️ *6. Мед эже* (Медициналык жардам)
💻 *7. Компьютердик жардам*
🚕 *8. Башка шаарларга такси* (Попутка)
🛠 *9. Уста чакыруу* (Сантехник, электрик, тойго ж.б.)
💪 *10. Күндө-Күш* (Ар кандай жумушчулар)
📖 *11. Маалымдама* (Эң керектүү номерлер)

📞 *Жардам керек болсо оператор:* 0226 410 410"""
...
OBLAST_TAXI_FIRST_MSG = """🚕 *Башка шаарларга такси (Попутка)*

Эмне керек — адам ташуу же жүк жеткирүү?

👤 *Адам* — башка шаарга / районго попутка
📦 *Жүк* — башка жакка буюм, пакет же башка нерсе жеткирүү

Мисалы: *Ошко 2 адам* же *Бишкекке пакет жеткирүү*"""

OBLAST_TAXI_PERSON_ROUTE_PROMPT = """🚕 *Башка шаарларга такси (Попутка)*

Кайдан кайда барасыз?

Мисалы: *Шамалды-Сайдан Ошко 2 адам*"""

OBLAST_TAXI_CARGO_ROUTE_PROMPT = """📦 *Башка шаарларга такси — жүк*
...
OBLAST_TAXI_CONFIRM_PERSON = """🚕 *Башка шаарларга такси (Попутка)*
...
OBLAST_TAXI_CONFIRM_CARGO = """📦 *Башка шаарларга такси — жүк*
