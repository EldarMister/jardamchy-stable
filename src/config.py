...
TAXI_CUSTOM_PRICE_PROMPT = """💰 Введите вашу цену:
Өзүңүздүн бааңызды жазыңыз:"""
...
📍 *Адрес / Дарек:* {address}
🚗 *Доставка / Жеткирүү:* договорная с таксистом

✅ Всё верно? Подтверждаете?
Баары туурабы? Тастыктайсызбы?"""

CONFIRM_SHOP = """🚚 *Доставка / Жеткирүү*
...
SUPPORT_TO_CLIENT = """🆘 *Тех поддержка / Колдоо кызматы*

📞 {support_phone}

Позвоните или напишите нам — мы поможем!
...
BLOCKED_MESSAGE = """🚫 *Вы заблокированы / Бөгөттөлдүңүз*

Обратитесь в тех поддержку: {support_phone}
...
Напишите кратко, например: мебель, мусор, кум, таш, мал, продукты..."""
