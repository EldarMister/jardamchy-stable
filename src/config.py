...
WELCOME_MESSAGE = """👋 *"Жардамчы GO"* — Шамалды-Сай

🍔 *1. Тамак* (Кафелер)
🛒 *2. Дүкөндөн жеткирүү*
🚕 *3. Тез Такси* (Шаар ичи)
🚚 *4. Портер* (Чоң жүк)
🛵 *5. Муравей* (Майда жүк)
💻 *6. Компьютердик кызмат*
🛣️ *7. Такси* (Башка шаарлар)
🛠️ *8. Уста чакыруу* (Сант., электр.)
💪 *9. Разнорабочий*
📖 *10. Эң керектүү номерлер*
🏠 *11. Ижарадагы батирлер*

📞 *Оператор:* 0226 410 410"""
