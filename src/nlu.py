...
Числительные кыргызского языка являются частью адреса — переводи в цифры:
  он=10, жыйырма=20, отуз=30, кырк=40, элүү=50, алтымыш=60, жетимиш=70, сексен=80, токсон=90
...
═══ ТИПЫ ГРУЗА (cargo_type) ═══
Определяй по ключевым словам:
• furniture  — мебель, диван, шкаф, стол, кровать, эмерек
• trash      — мусор, таштанды, хлам, мусорный
• construction — строй, кирпич, цемент, доски, курулуш, материал
• livestock  — скот, мал, корова, лошадь, овца, жылкы, уй-жаныбар
• groceries  — продукты, азык, азык-түлүк, тамак-аш, еда (груз с едой), мука, ун
• bags       — вещи, сумки, баштык, одежда, кийим, чемодан
• appliances — техника, телевизор, холодильник, стиральная, машина (электроника)
• other      — всё остальное, не подпадающее под категории выше
...
Ответь ТОЛЬКО валидным JSON (без markdown):
{
  ...
  "cargo_type": "furniture|trash|construction|livestock|groceries|bags|appliances|other или null",
