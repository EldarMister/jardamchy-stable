...
Груз — физический предмет, который перевозят: диван, холодильник, таш (камни), кум (песок),
мал (скот), мебель, стройматериалы, жыгач (дерево/брёвна), картошка, уголь и т.д.
Адрес — это МЕСТО (улица, магазин, ориентир, район города).

Записывай cargo_type ДОСЛОВНО. НЕ переводи и НЕ заменяй категориями. Если груз не упомянут — null.
...
Примеры (с суффиксами и без):
- "диван базардан северная 5га" → cargo="диван", from="базар", to="Северная 5"
- "диван базар северная 5" → cargo="диван", from="базар", to="Северная 5"
...
- "таш северная 5 базар" → cargo="таш", from="Северная 5", to="базар"
