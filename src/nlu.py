...
4. "porter"   - крупный груз/переезд (портер, жүк, мебель, стройматериалы, скот, мал, кум, таш, жыгач, уголь, кирпич, цемент)
5. "ant"      - мелкий груз/посылка (муравей, желмаян, кичи жүк, мелкий груз, посылка, ун ташыш, ун, картошка)
6. "greeting" - приветствие без запроса (салам, привет, здравствуй, ассаламу алейкум)
...
{
  "intent": "taxi|cafe|shop|porter|ant|greeting|unknown",
...
def parse_user_message(message: str) -> dict:
    ...
    Returns:
        {
            "intent": "taxi|cafe|shop|porter|greeting|unknown",
